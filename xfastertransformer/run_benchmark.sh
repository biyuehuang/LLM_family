...
#token_path="${SCRIPT_DIR}"/../examples/model_config/${model_name}/
model_path="/data/Llama-2-70B-Chat-hf-xft/"
token_path="/data/Llama-2-70B-Chat-hf/"
#model_path="/data/deepseek-coder-33b-instruct-xft/"
#token_path="/data/deepseek-coder-33b-instruct/"
#model_path="/data/Llama-2-13B-Chat-hf-xft/"
#token_path="/data/Llama-2-13B-Chat-hf/"
#model_path="/data/Meta-Llama-3-8B-xft/"
#token_path="/data/Meta-Llama-3-8B/"
#model_path="/data/Llama-2-7B-Chat-hf-xft/"
#token_path="/data/Llama-2-7B-Chat-hf/"
#model_path="/data/chatglm3-6b-xft/"
#token_path="/data/chatglm3-6b/"
